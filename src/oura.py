...
def get_sleep(start_date:str,stop_date:str,code:str="")->Tuple[bool,Dict[str,Tuple[str,str,str,str,int,int,int]]]:
    ...
    if response.status_code==200:
        ...
        with open("tmp.json", "w+") as f:
            json.dump(sleep,f,indent=3)
        return (True, {day["summary_date"]:(day["bedtime_start"][11:-6],day["bedtime_end"][11:-6],day["bedtime_start"][:10],day["bedtime_end"][:10],day["rem"],day["deep"],day["light"]) for day in sleep}) 
    else:
        print("Failed") 
        return (False,{})
