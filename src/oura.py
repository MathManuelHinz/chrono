...
def get_sleep(start_date:str,stop_date:str,code:str="")->Tuple[bool,Dict[str,Tuple[str,str,bool]]]:
    ...
    if response.status_code==200:
        ...
        print("Done")
        return (True, {day["summary_date"]:(day["bedtime_start"][11:-6],day["bedtime_end"][11:-6],not day["bedtime_start"][:11]==day["bedtime_end"][:11]) for day in sleep}) 
    else:
        print("Failed") 
        return (False,{})
